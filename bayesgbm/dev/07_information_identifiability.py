...
observable Jacobian has rank one. BayesGBM should report one null direction.
"""
import numpy as np
from bayesgbm import GaussianPrior,Priors,StateModel,Config,individual_fit,numerical_local_identifiability
